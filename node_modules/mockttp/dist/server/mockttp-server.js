...
class MockttpServer extends mockttp_1.AbstractMockttp {
    ...
    preprocessRequest(req) {
        request_utils_1.parseRequestBody(req, { maxSize: this.maxBodySize });
        ...
        if (!request_utils_1.isAbsoluteUrl(req.url)) {
            ...
            req.path = request_utils_1.getPathFromAbsoluteUrl(req.url);
        }
        const id = uuid();
    ...
    handleRequest(rawRequest, rawResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = request_utils_1.trackResponse(rawResponse, request.timingEvents, request.tags, { maxSize: this.maxBodySize });
    ...
    handleInvalidHttp1Request(error, socket) {
        ...
        setImmediate(() => __awaiter(this, void 0, void 0, function* () {
            ...
            const parsedRequest = rawPacket.byteLength > 1
                ? request_utils_1.tryToParseHttp(rawPacket, socket)
                : {};
            if (isHeaderOverflow)
                commonParams.tags.push('header-overflow');
            const request = Object.assign(Object.assign({}, commonParams), { httpVersion: parsedRequest.httpVersion, method: parsedRequest.method, protocol: parsedRequest.protocol, url: parsedRequest.url, path: parsedRequest.path, headers: parsedRequest.headers || {} });
            let response;
            if (socket.writable) {
                response = Object.assign(Object.assign({}, commonParams), { headers: { 'Connection': 'close' }, statusCode: isHeaderOverflow
                        ...
                        : "Bad Request", body: request_utils_1.buildBodyReader(Buffer.from([]), {}) });
