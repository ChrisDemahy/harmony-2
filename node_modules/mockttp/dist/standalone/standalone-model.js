...
const ScalarResolvers = {
    ...
    WebSocketHandler: new graphql_1.GraphQLScalarType({
...
function buildStandaloneModel(mockServer, stream) {
    ...
    return Object.assign({ Query: {
            ...
            addRule: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.addRule(rule_serialization_1.deserializeRuleData(input, stream));
            }),
            addRules: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.addRequestRules(...input.map((rule) => rule_serialization_1.deserializeRuleData(rule, stream)));
            }),
            setRules: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.setRequestRules(...input.map((rule) => rule_serialization_1.deserializeRuleData(rule, stream)));
            }),
            addWebSocketRule: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.addWebSocketRule(rule_serialization_1.deserializeWebSocketRuleData(input, stream));
            }),
            addWebSocketRules: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.addWebSocketRules(...input.map((rule) => rule_serialization_1.deserializeWebSocketRuleData(rule, stream)));
            }),
            setWebSocketRules: (__, { input }) => __awaiter(this, void 0, void 0, function* () {
                return mockServer.setWebSocketRules(...input.map((rule) => rule_serialization_1.deserializeWebSocketRuleData(rule, stream)));
            }),
            reset: () => {
                mockServer.reset();
                return true;
