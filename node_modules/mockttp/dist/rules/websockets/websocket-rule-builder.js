...
class WebSocketRuleBuilder extends base_rule_builder_1.BaseRuleBuilder {
    ...
    thenPassThrough(options = {}) {
        const rule = {
            ...
            handler: new websocket_handlers_1.PassThroughWebSocketHandler(options)
        };
    ...
    thenForwardTo(forwardToLocation, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const rule = {
                matchers: this.matchers,
                completionChecker: this.completionChecker,
                handler: new websocket_handlers_1.PassThroughWebSocketHandler(Object.assign(Object.assign({}, options), { forwarding: Object.assign(Object.assign({}, options.forwarding), { targetHost: forwardToLocation }) }))
            };
            return this.addRule(rule);
        });
    }
    ...
    thenCloseConnection() {
        const rule = {
            matchers: this.matchers,
            completionChecker: this.completionChecker,
            handler: new websocket_handlers_1.CloseConnectionHandler()
        };
        return this.addRule(rule);
    }
    /**
    ...
    thenTimeout() {
        const rule = {
            matchers: this.matchers,
            completionChecker: this.completionChecker,
            handler: new websocket_handlers_1.TimeoutHandler()
        };
        return this.addRule(rule);
    }
}
