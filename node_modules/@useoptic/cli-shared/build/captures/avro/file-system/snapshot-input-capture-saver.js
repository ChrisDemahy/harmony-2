...
async function main(inputFilePaths, outputBaseDirectory, captureId) {
...
const [, , inputEventsFilePath, inputInteractionsFilePath, outputBaseDirectory, captureId,] = process.argv;
main({ interactions: inputInteractionsFilePath, events: inputEventsFilePath }, outputBaseDirectory, captureId);
